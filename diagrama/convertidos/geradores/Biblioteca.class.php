...
class Biblioteca{
	...
	//teste se valor ja existe em determinado campo de uma tabela
	public final function valorJaExiste( $BD, $nome_campo, $nome_tabela, $condicoes, $valor ){
	
	$reg = $BD->get( "select ".$nome_tabela.".".$nome_campo." from ".$nome_tabela." where ".$nome_tabela.".".$nome_campo."='".$valor."' ".
	(strlen($condicoes)> 0? "and (".$condicoes.")":""));
	...
	public final function getDescricaoDeSolicitacao($cod_solicitacao){
	
	$descricao = "";		
		switch( $cod_solicitacao){
		...
		break;	
			...
			break;
				...
				case "kaspersky_prim":
				$descricao = "Primeira Compra de Licença Kaspersky";	
				break;
			
					case "kaspersky_renova":
					$descricao = "Renovação de Licença Kaspersky";	
					break;
					
						case "getcontrol":
						$descricao = "Software GetControl";	
						break;
			
							case "treinamento_pri":
							$descricao = "Treinamento Primeira Formação";	
							break;

								case "produtos":
								$descricao = "Solicitação de Produtos";	
								break;			
						
									case "treinamento_comp":
									$descricao = "Treinamento Formação Complementar";	
									break;
			
										case "mandriva":
										$descricao = "Software Mandriva Server";	
										break;
			
											case "oracle":
											$descricao = "Software Oracle Server";	
											break;
			
												case "suse":
												$descricao = "Software Suse Server";	
												break;
			
													case "vmware":
													$descricao = "Software VMWare";	
													break;
