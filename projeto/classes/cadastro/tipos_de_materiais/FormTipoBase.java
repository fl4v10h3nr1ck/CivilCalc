...
public abstract class FormTipoBase extends Dialogo {
...
protected TipoDeMaterial tipo;




	public FormTipoBase(String titulo, int largura, int altura, TipoDeMaterial tipo) {
	...
	protected boolean validacao(){
		...
		Mensagens.msgDeErro("Informe a nome do tipo de material.");
