...
public class FormNovoEncargoHoristaModelo extends FormEncargoHoristaModeloBase {
...
private static final long serialVersionUID = 1L;
	...
	public FormNovoEncargoHoristaModelo() {
	...
	public FormNovoEncargoHoristaModelo(Encargo_Horista_Modelo retorno) {
			
	super("Novo Encargo Horista (Modelo)", retorno);
	...
	this.retorno = new Encargo_Horista_Modelo();			
	...
	int id = new DAO<Encargo_Horista_Modelo>(Encargo_Horista_Modelo.class).novo(this.retorno);
	
	if(id<=0)
	return false;
	
	this.retorno.setId_encargo_horista_modelo(id);
