...
public abstract class FormEncargoHoristaModeloBase extends Dialogo {
...
protected Encargo_Horista_Modelo retorno;


protected PainelDeEncargoHorista painel;



	public FormEncargoHoristaModeloBase(String titulo, Encargo_Horista_Modelo retorno) {
	...
	this.add(this.painel =new PainelDeEncargoHorista(), cons);
	...
	protected boolean validacao(){
		...
		if(!Comuns.codigoPermitido(new DAO<Encargo_Horista_Modelo>(Encargo_Horista_Modelo.class), 
				this.tf_codigo.getText(), this.retorno!=null?this.retorno.getId_encargo_horista_modelo():0)){
