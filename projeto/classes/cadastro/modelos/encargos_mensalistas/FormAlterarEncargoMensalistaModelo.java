...
public class FormAlterarEncargoMensalistaModelo extends FormEncargoMensalistaModeloBase {
...
private static final long serialVersionUID = 1L;
	...
	public FormAlterarEncargoMensalistaModelo(Encargo_Mensalista_Modelo retorno) {
			
	super("Alterar Encargo Mensalista (Modelo)", retorno);
	...
	this.painel.tf_salario.setText(this.retorno.getSalario());
	...
	painel.tf_imprevistos.setText(this.retorno.getImprevistos());
	...
	return new DAO<Encargo_Mensalista_Modelo>(Encargo_Mensalista_Modelo.class).altera(this.retorno);
	}
