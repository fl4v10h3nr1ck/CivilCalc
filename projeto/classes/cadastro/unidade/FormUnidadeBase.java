...
public abstract class FormUnidadeBase extends Dialogo {
...
protected CampoLimitado tf_simbolo;
...
protected Unidade unidade;
	...
	public FormUnidadeBase(String titulo, Unidade unidade) {
		
	super(titulo, 650, 150);
	...
	p_1.add(new JLabel("<html>Sigla/Símbolo:<font color=red>*</font></html>"), cons);
	cons.gridwidth  = GridBagConstraints.REMAINDER;
	cons.weightx  = 0.7;
	...
	cons.gridwidth  = 1;
	cons.weightx  = 0.3;
	p_1.add(this.tf_simbolo = new CampoLimitado(200), cons);
	...
	textFieldList.add(this.tf_simbolo);
	...
	protected boolean validacao(){
		...
		if(this.tf_simbolo.getText().length() == 0){
			
		Mensagens.msgDeErro("Informe a sigla/símbolo da unidade de medida.");
		...
		Mensagens.msgDeErro("Informe o nome/descrição da unidade de medida.");
		Comuns.textFieldErroMode(this.tf_descricao);
		return false;	
		}
