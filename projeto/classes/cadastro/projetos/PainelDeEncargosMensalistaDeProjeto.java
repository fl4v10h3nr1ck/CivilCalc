...
public class PainelDeEncargosMensalistaDeProjeto extends PainelDeEncargoMensalista{
...
private Encargo_Mensalista encargo;




	public PainelDeEncargosMensalistaDeProjeto(Encargo_Mensalista encargo){
	...
	public void atualiza(Encargo_Mensalista encargo){
	...
	this.encargo = encargo;	
		...
		if(this.encargo!=null){
			...
			this.tf_salario.setText(this.encargo.getSalario());
			...
			this.tf_reincidencia_a2_c3.setText(this.encargo.getReincidencia_a2_c3());
	...
	if(this.encargo==null)
	this.encargo = new Encargo_Mensalista();
	...
	this.encargo.setSalario(this.tf_salario.getText());
	...
	this.encargo.setReincidencia_a2_c3(this.tf_reincidencia_a2_c3.getText());
	...
	if(this.encargo.getId_encargo_mensalistas()>0)
	return new DAO<Encargo_Mensalista>(Encargo_Mensalista.class).altera(this.encargo);
		else{
		
		int id =  new DAO<Encargo_Mensalista>(Encargo_Mensalista.class).novo(this.encargo);
		
		if(id>0)
		this.encargo.setId_encargo_mensalistas(id);
		else
		return false;
		}
