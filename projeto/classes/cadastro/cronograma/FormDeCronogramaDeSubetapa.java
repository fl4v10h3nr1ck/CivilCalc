...
public class FormDeCronogramaDeSubetapa   extends Dialogo {
...
private String etapa;
	...
	public FormDeCronogramaDeSubetapa(String etapa, int id_subetapa) {
	...
	this.subetapa = new DAO<Subetapa>(Subetapa.class).get(this.id_subetapa);
	
	List<Cronograma> aux  = new DAO<Cronograma>(Cronograma.class).get(
			null, "cron.tipo='SUBETAPA' and cron.fk_subetapa="+this.id_subetapa, null);
	...
	p_1.add(new JLabel("<html><b>ETAPA: "+this.etapa+" | SUBETAPA: "+(this.subetapa==null?"":this.subetapa.getTitulo())+"</b></html>"), cons);
