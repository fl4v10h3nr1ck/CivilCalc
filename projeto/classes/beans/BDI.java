...
@Anot_BD_Tabela(nome="bdi", prefixo="bd_i")
public class BDI {

	
@Anot_BD_Campo(nome = "id_bdi", tipo=int.class, set = "setId_bdi", get = "getId_bdi", ehId=true)		
private int id_bdi;
...
public int getId_bdi() {	return id_bdi;}
public void setId_bdi(int id_bdi) {	this.id_bdi = id_bdi;}
