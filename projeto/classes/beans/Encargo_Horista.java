...
@Anot_BD_Tabela(nome="encargos_horistas", prefixo="encg_ho")
public class Encargo_Horista {

	
@Anot_BD_Campo(nome = "id_encargo_horista", tipo=int.class, set = "setId_encargo_horista", get = "getId_encargo_horista", ehId=true)		
...
public int getId_encargo_horista() {
	return id_encargo_horista;
}

public void setId_encargo_horista(int id_encargo_horista) {
	this.id_encargo_horista = id_encargo_horista;
}
