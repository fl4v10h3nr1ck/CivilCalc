...
@Anot_BD_Tabela(nome="encargos_horistas_modelo", prefixo="encg_ho_m")
public class Encargo_Horista_Modelo {

	
@Anot_BD_Campo(nome = "id_encargo_horista_modelo", tipo=int.class, set = "setId_encargo_horista_modelo", get = "getId_encargo_horista_modelo", ehId=true)		
private int id_encargo_horista_modelo;
...
@Anot_BD_Campo(nome = "repouso_semanal", set = "setRepouso_semanal", get = "getRepouso_semanal")
...
public int getId_encargo_horista_modelo() {
	return id_encargo_horista_modelo;
}

public void setId_encargo_horista_modelo(int id_encargo_horista_modelo) {
	this.id_encargo_horista_modelo = id_encargo_horista_modelo;
}
...
public String getRepouso_semanal() {
	return repouso_semanal;
}

public void setRepouso_semanal(String repouso_semanal) {
	this.repouso_semanal = repouso_semanal;
}

public String getAux_enfermidade() {
	return aux_enfermidade;
}

public void setAux_enfermidade(String aux_enfermidade) {
	this.aux_enfermidade = aux_enfermidade;
}

public String getLicen_paternidade() {
	return licen_paternidade;
}

public void setLicen_paternidade(String licen_paternidade) {
	this.licen_paternidade = licen_paternidade;
}

public String getSalario_13() {
	return salario_13;
}

public void setSalario_13(String salario_13) {
	this.salario_13 = salario_13;
}
...
public void setVal_e(String val_e) {
	...
	public Encargo_Horista clona(){
		
	Encargo_Horista encargo = new Encargo_Horista();
	...
	encargo.setRepouso_semanal(this.getRepouso_semanal());
	encargo.setAux_enfermidade(this.getAux_enfermidade());
	encargo.setLicen_paternidade(this.getLicen_paternidade());
	encargo.setSalario_13(this.getSalario_13());
