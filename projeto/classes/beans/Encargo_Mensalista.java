...
@Anot_BD_Tabela(nome="encargos_mensalistas", prefixo="encg_me")
public class Encargo_Mensalista {

	
	@Anot_BD_Campo(nome = "id_encargo_mensalistas", tipo=int.class, set = "setId_encargo_mensalistas", get = "getId_encargo_mensalistas", ehId=true)		
	private int id_encargo_mensalistas;
		...
		public int getId_encargo_mensalistas() {
			return id_encargo_mensalistas;
		}

		public void setId_encargo_mensalistas(int id_encargo_mensalistas) {
			this.id_encargo_mensalistas = id_encargo_mensalistas;
		}
